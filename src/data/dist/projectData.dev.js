...
var _wheeloffortuneScreenshot = _interopRequireDefault(require("../assets/images/wheeloffortune-screenshot.png"));

var _punkbeersScreenshot = _interopRequireDefault(require("../assets/images/punkbeers-screenshot.png"));

var _jscalculatorScreenshot = _interopRequireDefault(require("../assets/images/jscalculator-screenshot.png"));

var _morsecodetranslatorScreenshot = _interopRequireDefault(require("../assets/images/morsecodetranslator-screenshot.png"));

var _alienbattleshipsScreenshot = _interopRequireDefault(require("../assets/images/alienbattleships-screenshot.png"));

var _mytodosScreenshot = _interopRequireDefault(require("../assets/images/mytodos-screenshot.png"));
...
var projectInfo = [{
  ...
  imageUrl: _punkbeersScreenshot["default"],
  ...
  imageUrl: _wheeloffortuneScreenshot["default"],
  isReversed: true,
  techstackIcons: [{
    size: "2xl",
  ...
  imageUrl: _mytodosScreenshot["default"],
  ...
  imageUrl: _jscalculatorScreenshot["default"],
  isReversed: false,
  techstackIcons: [{
    size: "2xl",
    icon: "fa-brands fa-html5 fa-inverse",
  ...
  imageUrl: _morsecodetranslatorScreenshot["default"],
  isReversed: true,
  techstackIcons: [{
    size: "2xl",
    icon: "fa-brands fa-html5 fa-inverse",
  ...
  imageUrl: _alienbattleshipsScreenshot["default"],
  isReversed: false,
  techstackIcons: [{
    size: "2xl",
    icon: "fa-brands fa-html5 fa-inverse",
